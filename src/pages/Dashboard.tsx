  ...
  return (
    <div className="min-h-screen bg-background">
      <header className="border-b border-border bg-card">
        <div className="container mx-auto px-4 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            ...
            <Button variant="ghost" size="icon" onClick={startTutorial} title="Start Tutorial">
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        {/* Quick Stats Grid */}
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8" data-tutorial="quick-stats">
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          {/* AI Insights */}
          <Card className="lg:col-span-2 shadow-health-sm" data-tutorial="ai-insights">
            <CardHeader>
              <CardTitle className="flex items-center gap-2 justify-between">
                ...
                <HelpTooltip 
                  section="features" 
                  description="These personalized insights are generated by the AI based on your real-time health data"
                />
              </CardTitle>
          ...
          <Card className="shadow-health-sm">
            ...
            <CardContent className="space-y-3">
              ...
              <Button 
                ...
                data-tutorial="health-agent-btn"
              >
        ...
        {/* Health Score */}
        <Card className="mt-6 gradient-primary text-primary-foreground shadow-health-md" data-tutorial="health-score">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 justify-between">
              <div className="flex items-center gap-2">
                <Award className="w-5 h-5" />
              ...
              <HelpTooltip 
                ...
                description="Your health score is calculated based on nutrition, activity, and consistency"
              />
            </CardTitle>
          </CardHeader>
          <CardContent>
